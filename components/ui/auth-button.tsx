  ...
  if (user) {
    ...
    return (
      <div className="flex items-center gap-2">
        <Link 
          href="/profile"
          className="w-10 h-10 rounded-full bg-secondary/50 hover:bg-secondary border border-border/50 flex items-center justify-center text-xs tracking-wider text-secondary-foreground font-mono transition-all duration-300 outline-none focus-visible:ring-1 focus-visible:ring-primary/50 cursor-pointer"
        >
          {initials}
        </Link>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button 
              className="w-6 h-6 rounded-full hover:bg-white/5 flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors outline-none focus-visible:ring-1 focus-visible:ring-primary/50 cursor-pointer" 
